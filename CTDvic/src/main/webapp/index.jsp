...
<div class="container-fluid">  <!--   body内所有内容都要包裹，作用是根据内容多少动态收缩  -->
    ...
    <!-- 滑块  -->
    <div class="row clearfix">
        <div class="col-md-12 " style="position: relative; overflow: hidden; width: 100%; height:400px;float:right; background: url(IMAGE/slide_bg.svg) no-repeat;background-size: cover !important; padding-top: 10px;">
            <div class="row clearfix">
                <div class="col-md-3">
                ...
                <div class="col-md-9 animate__animated animate__bounceInRight animate__slow">
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="col-md-12">
                                    <div class="thumbnail" style="height: 100%;">
                                        <div class="slide_s"><img src="IMAGE/database.png" style="width: 50%; height: 40%; position: relative; left: 25%;" /></div>
                                        <div class="caption">
                                            <h3>
                                                Search
                                            </h3>
                                            <p>
                                                The search interface provides precise query functions for Gene-Level (GL) and Variant-Level (VL), using a combination of keywords like disease, gene, variants type, et al.
                                            </p>
                                            <a href="search_mo.html"><button>Variant-orient(VL)</button></a>
                                            <a href="search_go.html"><button style="margin-top: 3px">Gene-orient(GL)</button></a>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="thumbnail" style="height: 100%;">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p>
                                                The curation interface provides a query for tumor driver genes and hotspot mutations predicted by the geMER algorithm.
                                            </p>
                            ...
                            <div class="swiper-slide">
                                <div class="col-md-12">
                                    <div class="thumbnail" style="height: 100%;">
                                        <div class="slide_s"><img alt="300x200" src="IMAGE/tools_icon.png" style="width: 80%; height: 40%; position: relative; left: 10%;"/></div>
                                        <div class="caption">
                                            <h3>
                                                Tools
                                            </h3>
                                            <p>
                                                ...
                                                A tool that utilizes mutation profiles and patient survival information to predict tumor driver genes and hotspot mutations, and perform survival analysis.
                                            <p>
                                                <a href="tools.html"><button>detail</button></a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="thumbnail" style="height: 100%;">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p>
                                                Providing bulk downloads of clinically relevant variants, genes, and predictive hotspot mutations.
                                            </p>
                                            <p>
                                ...
                                <div class="col-md-12">
                                    <div class="thumbnail" style="height: 100%;">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p>
                                                Experimentally validated missense mutations and hotspot mutations predicted are visualized on the Genome Browser.
                                            </p>
                                            <p>
            ...
            <div class="row clearfix">
                <div class="col-md-12 column">
                    ...
                    <ul class="nav nav-pills">
                        <li>
                            <a><img src="IMAGE/icon_al.png" style="width: 20px; height: 20px; position: relative; margin-right: 10px"> <span class="badge pull-right">24559</span>Total records</a>
                        </li>
                        <li>
                            <a><img src="IMAGE/icon_ds.png" style="width: 20px; height: 20px; position: relative; margin-right: 10px "> <span class="badge pull-right">107</span>Total Disease</a>
                        </li>
                        <li>
                            <a><img src="IMAGE/icon_gene.png" style="width: 20px; height: 20px; position: relative; margin-right: 10px "><span class="badge pull-right">2405</span>Toal Gene</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a><img src="IMAGE/icon_var_num.png" style="width: 20px; height: 20px; position: relative; margin-right: 10px "><span class="badge pull-right">466</span>variants counts</a>
                        </li>
                        <li>
                            <a><img src="IMAGE/icon_therapy.png" style="width: 20px; height: 20px; position: relative; margin-right: 10px "><span class="badge pull-right">300</span>Therapy</a>
                        </li>
                        <li>
                            <a><img src="IMAGE/icon_res.png" style="width: 20px; height: 20px; position: relative; margin-right: 10px "><span class="badge pull-right">484</span>Drug resistance</a>
                        </li>
                        <li>
                            <a><img src="IMAGE/icon_pro.png" style="width: 20px; height: 20px; position: relative; margin-right: 10px "><span class="badge pull-right">687</span>Prognosis</a>
                        </li>
                        <li>
                            <a><img src="IMAGE/icon_characters.png" style="width: 20px; height: 20px; position: relative; margin-right: 10px "><span class="badge pull-right">118</span>Tumor characters</a>
                        </li>
                        <li>
                            <a><img src="IMAGE/icon_mata.png" style="width: 20px; height: 20px; position: relative; margin-right: 10px "><span class="badge pull-right">83</span>Metastasis biomarker</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col-md-12 col-sm-12 column" id="index_foot_top" >
            ...
            <div class="col-md-5 col-sm-5 column">
                <div class="foot_message" data-aos="fade-up" data-aos-duration="1000"  data-aos-delay="1000">
                    <h4>Please cite:</h4>
                    <p>CTDvic: a comprehensive database of annotated and predicted circulating tumor DNA variants in cancer</p>
...
<script>
    ...
    var typede = new Typed('#typede', {
        strings: ['An open database of experimental supported circulating tumor DNA variants for clinical function annotation and prediction'],
        typeSpeed: 10,
        startDelay: 1500
    });
</script>
