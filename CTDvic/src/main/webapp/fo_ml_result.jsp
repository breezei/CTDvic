            ...
            <div class="row clearfix shift_down">
                <div class="col-md-12 column">
                    <%
                        ...
                        String col = "number, PMID,gene,`variant type`,`variant description`,disease,`body fluid`,`sequencing method`,experiment,mechanism,`"+function[0]+"`";
                        for(int i=1;i<function.length;i++){
                            function_ally=function_ally + " or `" + function[i] + "` != '_'";
                            col = col + ", `"+ function[i] +"`";
                        }
                        String search_sql=" SELECT * FROM mutation where disease in ("+disease_ally+") AND (" + function_ally +")";
                    %>
                    ...
                    <div id="content" class="r-box" data-aos="zoom-in" data-aos-duration="700" style="margin:0;text-align:left;width: 100%">
                        <div class="box_head">
                            <h4 class="pattern-diagonal-stripes-sm text-pattern" data-aos="flip-left" data-aos-duration="600" data-aos-delay="700">< Function-orient(VL) Search Result ></h4>
