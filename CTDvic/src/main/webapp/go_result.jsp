            ...
            <div class="row clearfix shift_down">
                <div class="col-md-12 column">
                    <%
                        ...
                        String search_sql;
                        search_sql="SELECT * FROM gene where disease in ("+disease_ally+") AND gene in ("+gene_ally+")";
                    %>

                    <%
                        try {
                            Class.forName("com.mysql.cj.jdbc.Driver"); //com.mysql.cj.jdbc.Driver都可以
                    ...
                    <div id="content" class="r-box" data-aos="zoom-in" data-aos-duration="700" style="margin:0;text-align:left;width: 100%">
                        <div class="box_head">
                            <h4 class="pattern-diagonal-stripes-sm text-pattern" data-aos="flip-left" data-aos="zoom-in" data-aos-duration="600" data-aos-delay="700">< Gene-orient(GL) Search Result ></h4>
