            ...
            <div class="row clearfix shift_down">
                <div class="col-md-12 column">
                    <%
                        ...
                        String search_sql = "SELECT * FROM mutation where disease = '"+para+"' OR gene = '"+para+"'";
                    %>
                    ...
                    <div id="content" class="r-box" data-aos="zoom-in" data-aos-duration="700" style="margin:0;text-align:left;width: 100%">
                        <div class="box_head">
                            <h4 class="pattern-diagonal-stripes-sm text-pattern" data-aos="zoom-in" data-aos-duration="600" data-aos-delay="700"> < Variant-orient(ML) Search Result ></h4>
